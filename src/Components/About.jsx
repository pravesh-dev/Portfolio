  ...
  return (
    <div ref={componentRef} id="about" className="w-full h-[100svh] relative box-border sm:flex sm:flex-row sm:items-center sm:justify-center sm:gap-5 lg:gap-12 xl:gap-44 overflow-x-hidden">
      ...
      <div className="w-full h-[40%] relative flex items-center px-3 sm:w-auto sm:h-auto">
        <div className="w-48 h-[11.3rem] relative sm:w-80 sm:h-[19.3rem] lg:w-[26rem] lg:h-[25.3rem]">
          <div className="w-[85%] h-[80%] relative flex items-end z-20 overflow-hidden">
            <img loading="lazy" className="imgBg w-full h-[80%] object-cover" src={aboutBg} alt="" />
            <img loading="lazy"
              src={myImage}
      ...
      <div className="w-full flex flex-col gap-11 -mt-28 relative z-10 px-3 sm:mt-0 sm:gap-5 sm:w-1/2 sm:h-auto md:w-[25rem] lg:w-[33rem] lg:gap-8 xl:w-[37rem]">
        ...
        <p className="aboutContent text-neutral-300 text-xs tracking-widest leading-[1.1rem] text-justify font-extralight flex flex-col gap-5 lg:text-[0.95rem] lg:leading-5 lg:tracking-[0.13rem] xl:tracking-[0.17rem] xl:leading-[1.3rem]">Hi, I'm Pravesh Saini, a frontend web developer who loves making websites that are easy to use and look great. I have skills in HTML, CSS, JavaScript, React, Tailwind CSS, and GSAP. At HexaDefend, I worked on many projects with a great team and learned how to build responsive and attractive websites. I focus on writing clean code and creating smooth user experiences. I'm always looking for new challenges and enjoy keeping up with the latest trends in web development. <span className="w-14 h-[0.12rem] bg-white self-end mr-7 lg:h-[0.15rem] xl:mr-20"></span></p>
        <div className="flex gap-7 pl-3 sm:gap-4 sm:justify-between md:justify-start md:gap-10 lg:gap-14">
          <div className="btn1"><HireButton/></div>
          <button className="resumeDownload relative border border-primary text-white text-[0.65rem] rounded-md tracking-wider font-light lg:text-base cursor_pointer active:scale-95 duration-300 overflow-hidden opacity-0 translate-x-[100px]"><a className="text-transparent px-5 py-2 lg:px-8 cursor_pointer" href="/Resume/PRAVESH-RESUME.pdf" download='PRAVESH-RESUME' aria-label="Download Resume">Download Resume</a> <span className="inner_circle bg-primary/60 rounded-full pointer-events-none"></span></button>
        </div>
      </div>
