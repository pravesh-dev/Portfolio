...
function Footer() {
  return (
    <div className='w-full h-52 flex flex-col justify-center gap-4 px-2 bg-[#161616] md:h-32'>
      <div className='w-full flex text-white flex-col gap-2 md:flex-row md:justify-between md:mt-6'>
        <h2 className='text-white text-[0.9rem] font-yellowTail'>Developed By <span className='text-primary font-bold tracking-wider'>Pravesh</span></h2>
