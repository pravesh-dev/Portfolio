...
function Projects() {
  ...
  const renderProjects = (type) => {
    ...
    return displayedProjects.map((project, index) => (
      <div
        key={index}
        className="w-36 bg-[#353535] p-[0.33rem] rounded-md sm:w-56 flex gap-1 flex-col justify-between sm:gap-2 sm:p-3 lg:w-64 xl:w-72 lg:hover:scale-110 lg:hover:rotate-6 duration-300 lg:hover:bg-[#242532]"
      >
