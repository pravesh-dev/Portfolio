...
function Skills() {
  return (
    <div className='w-full h-screen relative flex justify-between items-center'>
      ...
      <div className='w-32 border flex flex-col gap-5'>
        <div className='flex flex-col gap-1'>
          <h2 className='text-white text-xl font-bold'>HTML</h2>
          <p className='text-[0.6rem] text-white font-extralight tracking-widest leading-3 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae esse cum incidunt similique. Totam, aliquam.</p>
        </div>
        <div className='flex flex-col gap-1'>
          <h2 className='text-white text-xl font-bold'>HTML</h2>
          <p className='text-[0.6rem] text-white font-extralight tracking-widest leading-3 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae esse cum incidunt similique. Totam, aliquam.</p>
    ...
    <h1 className='text-primary text-xl font-bold tracking-widest -rotate-90 whitespace-nowrap absolute left-1/2 -translate-x-1/2'>PROFESSIONAL SKILLS</h1>
