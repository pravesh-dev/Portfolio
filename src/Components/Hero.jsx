...
function Hero() {
  return (
    <div className="w-full h-[100svh] relative overflow-y-auto">
      <HeroDecoration />
      <div id="hero-top" className="h-[70%] w-full flex relative lg:h-[80%]">
        ...
        <a href="https://www.instagram.com/dev_pravesh/" target="_blank" rel="noopener noreferrer" className="relative duration-300 hover:rotate-6 hover:scale-125 cursor_pointer">
          ...
          <a href="whatsapp://send?phone=919991831473" target="_blank" rel="noopener noreferrer" className="relative duration-300 hover:rotate-6 hover:scale-125 cursor_pointer">
          ...
          <a href="https://www.linkedin.com/in/pravesh-saini-b7ab39280/" target="_blank" rel="noopener noreferrer" className="relative duration-300 hover:rotate-6 hover:scale-125 cursor_pointer">
          ...
          <a href="https://github.com/pravesh-dev" target="_blank" rel="noopener noreferrer" className={`relative mb-8 lg:mb-14 duration-300 hover:rotate-6 hover:scale-125 cursor_pointer`}>
      ...
      >
        ...
        <div className="w-[7.2rem]">
          ...
          <a className="text-[0.5rem] text-white/50 lg:text-[0.6rem] cursor_pointer" href="tel:+9991831473">
            9991831473
          </a>
